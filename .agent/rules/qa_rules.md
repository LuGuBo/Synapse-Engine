...
3. **Escrita do Relatório de Entrega**: Você deve redigir o `walkthrough.md` em **Inglês (EN-US)**, detalhando os testes rodados, resultados obtidos e comportamento da aplicação.
